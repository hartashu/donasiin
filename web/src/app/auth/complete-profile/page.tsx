...
//   if (!token) {
//     // FIX: Mengirim parameter untuk dibaca oleh toast di halaman register
...
// FIX: Tipe untuk searchParams diubah menjadi Promise
interface CompleteProfilePageProps {
...
export default async function CompleteProfilePage({
  ...
  // FIX: Tambahkan 'await' untuk "membuka" Promise-nya
