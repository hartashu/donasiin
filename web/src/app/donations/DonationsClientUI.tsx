        ...
        <div className="min-h-screen flex flex-col bg-gray-50">
            ...
            <div className="flex flex-1">
                {isDonationsRoute && (
                    <>
                        <div
                            className={`md:hidden fixed inset-0 z-50 flex ${showSidebar ? "pointer-events-auto" : "pointer-events-none"
                                }`}
                        >
                            <div
                                className={`fixed inset-0 bg-black bg-opacity-40 transition-opacity duration-300 ${showSidebar ? "opacity-100" : "opacity-0"
                                    }`}
                                    ...
                                    {categories.map((item) => (
                                        <li key={item.path}>
                                            <Link
                                                ...
                                                onClick={() => setShowSidebar(false)}
                                                className={`block px-3 py-2 rounded-md transition font-medium ${pathname === item.path
                                ...
                                <ul className="space-y-1">
                                    {categories.map((item) => (
                                        <li key={item.path}>
                                            <Link
                                                href={createCategoryLink(item.path)}
                                                className={`block px-2 py-1.5 text-sm rounded-md ${pathname === item.path
