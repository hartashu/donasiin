...
export default function Stats() {
            ...
            countRefs.current.forEach((ref, i) => {
                if (ref)
                    animate(0, targets[i], {
                        ...
                        onUpdate: (v) => {
                            ref.textContent =
                                i === 2 ? v.toFixed(1) : Math.floor(v).toLocaleString();
                        },
                    });
            });
        }
    ...
    return (
        <section
            ref={sectionRef}
            className="text-center py-20 md:py-24 container mx-auto px-6"
        >
            <motion.div
            ...
            >
                ...
                <p className="max-w-3xl mx-auto text-lg mb-16 text-green-100/70">
                    Small actions, big changes. Here&rsquo;s what we&rsquo;ve achieved
                    together.
                </p>
            </motion.div>
