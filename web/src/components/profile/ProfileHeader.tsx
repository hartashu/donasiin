...
//     activityFeed: Activity[]; // Tipe ini sekarang sudah sesuai
//     onEdit: () => void;
// }
...
//     onEdit,
// }: ProfileHeaderProps) {
//     // FIX: Semua logika transformasi 'timelineActivities' dihapus karena sudah tidak diperlukan.
//     // Data 'activityFeed' dari server sudah dalam format yang benar.
...
//                             {" "}
//                             {stats.dailyRequestsMade} / {profile.dailyLimit}
//                         </span>
//                     </p>
//                 </div>
//             </div>
...
//                 {/* FIX: Langsung teruskan 'activityFeed' ke ActivityTimeline */}
...
import { IUser, Achievement, Activity } from "@/types/types";
import Image from "next/image";
import { Edit, LogOut, MapPin, CalendarDays, Clock } from "lucide-react";
import { signOut } from "next-auth/react";
import { format } from "date-fns";
import { CarbonSummary } from "./CarbonSummary";
import { Achievements } from "./Achievements";
    ...
    <div className="bg-white p-5 rounded-2xl shadow-lg w-full space-y-5">
      <div className="flex items-start gap-4">
        <Image
          ...
          className="rounded-full border-4 border-white flex-shrink-0 shadow-md"
        />
        {/* FIX: Tambahkan `min-w-0` agar kontainer ini bisa mengecil */}
        <div className="flex-grow pt-2 min-w-0">
          {/* FIX: Tambahkan `break-words` agar teks bisa pindah baris */}
